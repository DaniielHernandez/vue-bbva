<template>
  ...
  >
    <bbva-web-link
      class="primary fw-500 padding-invoker"
      slot="invoker"
      icon="bbva:show"
      @click="show">
    ...
    <div>
      ...
      <div role="radiogroup" class="radio-custom-grid">
        <bbva-web-form-radio-button
          key="input-is-compliance-radio-1"
          ambient="dark"
          name="compliance"
          :checked="radioFilters.compliance"
          @change="() => updateRadioFilter('compliance', true)">
          <span class="fs-15 fc-white">Cumplimiento</span>
        </bbva-web-form-radio-button>
        <bbva-web-form-radio-button 
          key="input-is-uncompliance-radio-2"
          name="uncompliance"
          ambient="dark"
          @change="() => updateRadioFilter('compliance', false)"
          :checked="!radioFilters.compliance">
          <span class="fs-15 fc-white">Incumplimiento</span>
        </bbva-web-form-radio-button>
      </div>
...
/*
 * This methos shows the tooltip to choose between compliance and decimals
 */
export default {
  data() {
    return {
  ...
  props: {
    ...
    /* Radio filter */
    radioFilters: {  type: Function, default: () => ({}) },
  }
};
</script>
